...
const RemovePurchaseReq = () => {
    ...
    const handleRemove = async () => {
        ...
        for (let i = 0; i < total; i++) {
            ...
            try {
                await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/remove-purchase-requests`, {
                ...
                temp[i].status = err.response?.data?.sapMessage || "Removal failed";
            }
            temp[i].progress = 100;
            setRows([...temp]);
...
export default RemovePurchaseReq;
